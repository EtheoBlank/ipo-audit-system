...
注意:
  ...
  * 根路径 ``/`` 由 ``app/web/routes.py`` 提供 Jinja2 dashboard (不是 Swagger UI).
  * 所有 URL 路径全部 rewrite 到这里:
        https://<your-project>.vercel.app/              → Dashboard (Web UI)
        https://<your-project>.vercel.app/projects      → 项目列表
        https://<your-project>.vercel.app/docs          → Swagger UI (240 endpoints)
